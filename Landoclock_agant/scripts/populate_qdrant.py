...
This script loads .txt files from data/real_estate_knowledge/ directory,
...
# Configuration
KNOWLEDGE_DIR = Path(__file__).parent.parent / "data" / "real_estate_knowledge"
CHUNK_SIZE = 500
CHUNK_OVERLAP = 100
...
def clear_collection() -> None:
    ...
    """
    from config.qdrant_config import get_qdrant_client, delete_collection
...
def main():
    ...
    """
    print("=" * 60)
    print("🚀 Land O'Clock Qdrant Knowledge Base Populator")
    print("=" * 60)
    print()
