      ...
      <div class="image-section">
        ...
        <div class="brand-content">
          <div class="brand-logo">
            ...
            <h1 class="brand-name">AgentPortal</h1>
          </div>
          <div class="brand-description">
            <h2>Agent Access</h2>
            <p>Connect with your job seekers and manage your  dashboard with powerful tools and insights.</p>
          </div>
      ...
      <div class="form-section">
        <div class="form-container">
          <div class="form-header">
            <h1 class="form-title">Agent Login</h1>
            <p class="form-subtitle">Sign in to your agent portal</p>
          </div>
    ...
    async login() {
      ...
      try {
        ...
        if (response.data.token) {
          // Store agent token (keeping original localStorage keys)
          localStorage.setItem("agentToken", response.data.token);
          localStorage.setItem("userEmail", this.email);
          localStorage.setItem("agentRoleId", this.role_id);

          this.$nextTick(() => {
            console.log("Redirecting to /agent/index...");
